...
def find_solutions(in_matrix, b) -> list[float]:
    height = len(in_matrix)
    res = [0.0 for _ in range(height)]
...
def determinant(matrix):
    triangular_matrix, permutations_count = to_triangular(matrix)
    product = 1
